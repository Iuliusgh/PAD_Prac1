        ...
        if(!seInsertaronDatosIniciales) {
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    repository.insert(new Senal("Únicas direcciones y sentidos permitidos\n", "Las flechas señalan la única dirección y sentidos que los\n vehículos pueden tomar",false,"R-403c","azul","circulo"));
