        ...
        if(!seInsertaronDatosIniciales) {
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    repository.insert(new Senal("STOP", "Obligación para todo conductor de detener su vehículo ante la " +
                            "próxima línea de detención o," +
                            " si no existe, inmediatamente antes de la intersección," +
                            " y ceder el paso en ella a los vehículos que circulen por la vía a la que se aproxime." +
                            " Si, por circunstancias excepcionales," +
                            " desde el lugar donde se ha efectuado la detención no existe visibilidad suficiente," +
                            " el conductor deberá detenerse de nuevo en el lugar desde donde tenga visibilidad," +
                            " sin poner en peligro a ningún usuario de la vía.",false,"R-2"));
