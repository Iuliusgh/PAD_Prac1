        ...
        if(!seInsertaronDatosIniciales) {
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    repository.insert(new Senal("Entrada prohibida a vehículos que transporten mercancías peligrosas", "Señal de tráfico R-108 que prohíbe el paso de vehículos destinados al transporte de mercancías peligrosas",false,"R-108"));
                    repository.insert(new Senal("Entrada prohibida a vehículos agrícolas de motor", "Señal de tráfico R-111 que prohíbe la entrada de vehículos a motor dedicados a labores de agricultura",false,"R-111"));
                    repository.insert(new Senal("Entrada prohibida a vehículos de tracción animal", "Prohibición de acceso a vehículos de tracción animal.",false,"R-113"));
                    repository.insert(new Senal("Entrada prohibida a ciclos", "Prohibición de acceso a ciclos. ",false,"R-114"));
                    repository.insert(new Senal("Entrada prohibida a peatones ", "Prohibición de acceso a peatones. ",false,"R-116"));
                    repository.insert(new Senal("Entrada prohibida a animales de montura", "Prohibición de acceso a animales de montura. ",false,"R-117"));
                    repository.insert(new Senal("Prohibición de pasar sin detenerse", "Indica el lugar donde es obligatoria la detención por la \n proximidad, según la inscripción que contenga, de un puesto \n de aduana, de policía, de peaje u otro, tras los cuales pueden \n estar instalados medios mecánicos de detención. En todo \n caso, el conductor así detenido no podrá reanudar su marcha \n hasta haber cumplido la prescripción que la señal establece.  ",false,"R-200"));
